...
<div class="container">
    <div class="row">
      ...
      <div class="col-md-8">
      <a href="#addchemistry" data-toggle="modal" class="btn btn-info">ایجاد سوالات تاریخ</a>
        ...
        <!-- select question -->
           ...
           <table class="table table-bordered" id="example" >
            ...
            <tbody>
            @if(count($history_question) > 0 )
                @foreach($history_question as $history)
              <tr>
                <td>{{$history->id}}</td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="delete_history{{$history->id}}" type="submit" id="submit"  class="btn btn-success">بلی</a>
