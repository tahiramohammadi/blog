...
<div class="container">
    <div class="row">
      ...
      <div class="col-md-8">
      <a href="#addchemistry" data-toggle="modal" class="btn btn-info">ایجاد سوالات دری</a>
        ...
        <!-- select question -->
           ...
           <table class="table table-bordered" id="example" >
            ...
            <tbody>
            @if(count($persian_question) > 0 )
                @foreach($persian_question as $history)
              <tr>
                <td>{{$history->id}}</td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="delete_persian{{$history->id}}" type="submit" id="submit"  class="btn btn-success">بلی</a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <button type="button" aria-label="close" class="close" data-dismiss="modal">
          ...
          <form action="update_persian{{$history->id}}" method="post">
            @csrf
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <button type="button" aria-label="close" class="close" data-dismiss="modal">
          ...
          <form action="{{route('add_persian')}}" method="post">
            @csrf
